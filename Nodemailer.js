...
const MailServer = async function main() {
  ...
  let info = await transporter.sendMail({
    ...
    html:
      "<body><h3>Hello and thank you my friend.</h3><p>Jag har bilen full på grejjor. Ipads, macboooks, mobill & kaffe i lösvikt.<br /> Faktura kommer att skickas om 5 minuter om du inte avbryter beställningen <a href='http://erdetfredag.dk'>här</a>.</p></body>" // html body
  });
