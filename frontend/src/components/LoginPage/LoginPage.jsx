            ...
            <Row>
                <Col className='content'>
                    ...
                    <Col node="form" onSubmit={handleSubmit} l={12} className="form">
                        ...
                        <TextInput className="form-control" name="password" onChange={handleInputChange} value={inputs.password} label="Password" autoComplete="password" password={true} s={12} l={12} required />
